    ...
    const trackPurchase = () => {
      if (typeof window.gtag === 'function') {
        window.gtag('event', 'purchase_success', {
          ...
          event_label: 'transfer Order Success'
        });
      }
    };
    trackPurchase();
  ...
  const steps = [
    {
      ...
      descriptionsent: t('steps.processing.descriptionsent')
    },
    {
      icon: <Phone className="w-6 h-6" />,
      title: t('steps.confirmation.title'),
      descriptionsent: t('steps.confirmation.descriptionsent')
    },
    {
      icon: <Clock className="w-6 h-6" />,
      title: t('steps.delivery.title'),
      descriptionsent: t('steps.delivery.descriptionsent')
    }
  ];
